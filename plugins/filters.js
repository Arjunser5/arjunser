...
const array = ['acho','Velluveli','udayp','tutu','Thug','suhurth','Single boy','Settak','sena','Sed','sed life','sed bgm','Sarasu','Role','Reyali','Poyalo','power varate','Power an','Pottikum','poli','Podamyr','pm vada','Pabam','onu poda chekka','oh','O','number pottikum','no love','nerth','Nenak nan und','ne power an','ne etha','nanban fake','nan und','MPL','Monuse','money hist bgm','mone','Mandan','Machane','lshta','Love','Love you','Love me','line','line undo','Ketto','karale','Kane','kalikuno','kalikkan nekkale','Kalikkale','joker','Inna pedicho','i love u','I love you baby','@918593079460','aliya','ano','arakkal tharavad','arakkal','Aran ariyo','ariyo','arulla','ayn','Ayo','AyoAyo','Badboy','Bgm ettutharam','Bgm ille','BGM poratte','Bgm','Da','Hi','hlo','kannapi','kollamo','kollum nan','myr','ok','polichille','poda','ramana','sad','sorry','tharilla','Boss ethi','Bosse','chalakallada','Chank uyr','Chank','chankan','Chettan oru bgm ettu tharate','coming','Don','Dream','gays','ennalum','Entry','ennit','Group','Groupel','1','2','aara','Aarulle','adi','10thc','Abhay','agana','Adhila','Apple','Arjun','Arjunsad','ARJUNSER','Arjunser2','Baby','bgm idu','bot','Botser','connection','fire','Happy birthday','happy','Kichuz','KANNAPI','Shibhil','sing','sundhara','Will you marry me','uyree','theri','Thendi','polayatu','set','Powersh','Power','umba','Nanban','Freash','Agana irrikina','Arjun','BGM5','Do it','Fuck','Kunna song','Myre','Ninnta','Pic','Redlight','Shibhil','Wait','money','Nanban','REMIX','Venda','Good night']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
       await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/' + a + '.mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted: message.data, ptt: true})
...
const array = ['Pinky','asena','ayin','back','Back','Bot','fuck','Fuck','Hehe','Hello','Hlo','Kill','kill','kiss','line','love','mwolu','Mwolu','single','tha','thund','z','Z','bie','Bie','uff','umma','Vaa','vada','yo','umbi','Shibhil','no girls','Love you','Girls','Devan','arjunser','Adhila','ARJUNSER','Ayo','Biolagy']
array.map( async (a) => {
let pattern = new RegExp(`\\b${a}\\b`, 'g');
if(pattern.test(message.message)){
